...
public class EventController {
    ...
    public ResponseEntity<List> getFilteredEvents(@RequestBody Map<String, Object> payload){
        ...
        try{ 
            ...
            System.out.println(" evento activo:"+eventoActivo+ " "+payload.get("eventoActivo"));
    ...
    public ResponseEntity<List<EventDTO>> getEventsForMap() {
        List<EventDTO> events = this.eventServiceImplement.getAllEventToMap();
